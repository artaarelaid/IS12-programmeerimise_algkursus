...
x = 2	#eluka algkoordinaadid, X ja Y
y = 2
pattern = []
force_dir = 0           #sunnib eluka suuna
force_start = 0
...
elukas = "\033[91m" + elukas + "\033[0m"	#muudab eluka värvi

print elukas

def set_direction():  #eluka suuna määramine
global x
global y
global direction
global pattern
...
if not force_dir:         #sunnib elukat liikuma player'i suunas
if px > x and py > y:
...
if len(pattern) > 4:  #kood selle jaoks et elukas ei jääks lõputult vasakule-paremale vms liikuma
